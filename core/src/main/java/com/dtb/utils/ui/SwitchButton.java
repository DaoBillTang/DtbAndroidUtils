...
import static com.dtb.utils.commons.utils.DensityUtilsKt.dip2px;
...
public class SwitchButton extends View implements Checkable {
    private static final int DEFAULT_WIDTH = dip2px(58);
    private static final int DEFAULT_HEIGHT = dip2px(36);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkLineWidth = optPixelSize(typedArray,
                ...
                dip2px(1f));//dip2px(1.0f);

        checkLineLength = dip2px(6);
